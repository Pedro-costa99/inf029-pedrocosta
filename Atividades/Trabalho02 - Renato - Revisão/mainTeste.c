...
{// posição, tamanho
    ...
    printf("%d\n", inserirNumeroEmEstrutura(3, 2) == SEM_ESTRUTURA_AUXILIAR);
...
{   // posição, tamanho
    ...
    printf("%d\n", criarEstruturaAuxiliar(3, -5) == TAMANHO_INVALIDO);
    printf("%d\n", criarEstruturaAuxiliar(3, 0) == TAMANHO_INVALIDO);
    printf("%d\n", criarEstruturaAuxiliar(3, 3) == SUCESSO);
...
void testeInserirComEstrutura()
{
    ...
    printf("%d\n", inserirNumeroEmEstrutura(2, 4) == SEM_ESTRUTURA_AUXILIAR);//sucesos
    printf("%d\n", inserirNumeroEmEstrutura(2, -2) == SEM_ESTRUTURA_AUXILIAR);//sucesso
    printf("%d\n", inserirNumeroEmEstrutura(2, 6) == SEM_ESTRUTURA_AUXILIAR);//sem espaço(antes estava sucesso, mas mudei)
    printf("%d\n", inserirNumeroEmEstrutura(2, 5) == SEM_ESTRUTURA_AUXILIAR);//sem espaço
}
/*
2 [4,-2,6]
*/
